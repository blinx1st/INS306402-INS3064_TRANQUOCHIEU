<section class="panel">
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:24px;align-items:center;">
        <div>
            <h1 class="page-title"><?= h($data['title'] ?? 'CLB Tin Học NTU') ?></h1>
            <p style="font-size:19px;line-height:1.7;">Website hỗ trợ quản lý thành viên, sự kiện, nhóm học tập, bài đăng, điểm danh và gửi email cho Câu lạc bộ Tin học Trường Đại học Nha Trang.</p>
            <div class="toolbar">
        ...
        <img src="<?= asset_url('Image/Banner.jpg') ?>" alt="CLB Tin Học" style="width:100%;border-radius:8px;object-fit:cover;max-height:360px;">
    </div>
</section>
