...
return [
    ...
    'CLB' => [
        ...
        'pk' => ['MaCLB'],
        'title' => 'Câu lạc bộ',
        'select' => 'CLB.*, ThanhVien.HoTen AS ChuNhiemTen',
        'join' => 'LEFT JOIN ThanhVien ON ThanhVien.MaThanhVien = CLB.ChuNhiem',
        'order' => 'CLB.MaCLB ASC',
        'fields' => [
    ...
    'ThanhVienCLB' => [
        ...
        'select' => 'ThanhVienCLB.*, CLB.TenCLB, ThanhVien.HoTen, ThanhVien.Email',
        'join' => 'LEFT JOIN CLB ON CLB.MaCLB = ThanhVienCLB.MaCLB LEFT JOIN ThanhVien ON ThanhVien.MaThanhVien = ThanhVienCLB.MaThanhVien',
        'order' => 'CLB.TenCLB ASC, ThanhVien.HoTen ASC',
        'fields' => [
    ...
    'SuKien' => [
        ...
        'pk' => ['MaSuKien'],
        'title' => 'Sự kiện',
        'select' => "SuKien.*, CLB.TenCLB, ThanhVien.HoTen AS NguoiToChucTen, LoaiSuKien.TenLoaiSuKien, (SELECT COUNT(*) FROM ThanhVienSuKien tvsk WHERE tvsk.MaSuKien = SuKien.MaSuKien AND tvsk.TrangThaiThamGia <> 'Đã hủy') AS SoDangKy, (SELECT COUNT(*) FROM CheckinSuKien ck WHERE ck.MaSuKien = SuKien.MaSuKien) AS SoCheckin, GREATEST(SuKien.SucChua - (SELECT COUNT(*) FROM ThanhVienSuKien tvsk2 WHERE tvsk2.MaSuKien = SuKien.MaSuKien AND tvsk2.TrangThaiThamGia <> 'Đã hủy'), 0) AS SoChoConLai",
        'join' => 'LEFT JOIN CLB ON CLB.MaCLB = SuKien.MaCLB LEFT JOIN ThanhVien ON ThanhVien.MaThanhVien = SuKien.NguoiToChuc LEFT JOIN LoaiSuKien ON LoaiSuKien.MaLoaiSuKien = SuKien.MaLoaiSuKien',
    ...
    'CheckinSuKien' => [
        ...
        'select' => 'CheckinSuKien.*, SuKien.TenSuKien, CLB.TenCLB, ThanhVien.HoTen, NguoiXacNhan.HoTen AS XacNhanBoiTen',
        'join' => 'LEFT JOIN SuKien ON SuKien.MaSuKien = CheckinSuKien.MaSuKien LEFT JOIN CLB ON CLB.MaCLB = SuKien.MaCLB LEFT JOIN ThanhVien ON ThanhVien.MaThanhVien = CheckinSuKien.MaThanhVien LEFT JOIN ThanhVien NguoiXacNhan ON NguoiXacNhan.MaThanhVien = CheckinSuKien.XacNhanBoi',
        'order' => 'CheckinSuKien.ThoiGianCheckin DESC, CheckinSuKien.MaCheckin DESC',
        'fields' => [
