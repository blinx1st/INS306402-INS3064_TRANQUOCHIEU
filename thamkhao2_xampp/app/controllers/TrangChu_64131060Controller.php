...
class TrangChu_64131060Controller extends Controller
{
    ...
    public function GioiThieu_AdminPage_64131060(): void { $this->about('Trang giới thiệu (Chủ nhiệm)', 'AdminPage_64131060'); }
    public function GioiThieu_AssitantPage_64131060(): void { $this->about('Trang giới thiệu (Trợ giảng)', 'AssistantPage_64131060'); }
    public function GioiThieu_MemberPage_64131060(): void { $this->about('Trang giới thiệu (Thành viên)', 'MemberPage_64131060'); }
